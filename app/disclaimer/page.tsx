...
export const metadata: Metadata = buildPageMeta({
  ...
  description:
    "RefurbMeter's disclaimers: we are an independent comparison platform, prices change, and purchases happen with the seller.",
});
  ...
  return (
    <div className="container max-w-3xl space-y-6 py-10">
      ...
      <section className="space-y-2">
        ...
        <p className="text-sm leading-relaxed text-[var(--text-muted)]">
          RefurbMeter never owns, sells, ships, services, refunds or
          warranties devices, and never handles payments. All transactions occur
          directly between you and the seller. RefurbMeter is not a party to
